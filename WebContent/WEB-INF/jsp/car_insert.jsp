  	         ...
  	         <c:if test="${error!=null }">
				${ error}<br/>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="${pageContext.request.contextPath }/car/insertCarSubmit.action" method="post">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">用户名</label>
									<div class="col-sm-8">
										<input name="userCustom.uname" type="text" class="form-control1" id="focusedinput" value="">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="cname" type="text" class="form-control1" id="disabledinput" value="">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">车辆品牌</label>
									<div class="col-sm-8">
										<input name="ctype" type="text" class="form-control1" id="inputPassword" value="">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">出厂时间</label>
									<div class="col-sm-8">
										<input name="cproduct" type="text" class="form-control1" id="inputPassword" value="">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">排量</label>
									<div class="col-sm-8">
										<input size="20" name="cdisplacement" type="text" class="form-control1" id="inputPassword" value="">
									</div>
								</div>
								...
								<div class="row">
									<div class="col-sm-8 col-sm-offset-2">
										<input type="submit" class="btn btn-primary" value="提交">
              							<input type="button"  class="btn btn-default" value="返回" onclick="javascript:window.location.href='${pageContext.request.contextPath}/car/queryCarByCnamePage.action'"/>
									</div>
								</div>
							 </div>
							 </form>
