...
function queryDtcByDcodePage() {
	document.dtcForm.action="${pageContext.request.contextPath }/dtc/queryDtcByDcodePage.action";
	document.dtcForm.submit();
}

function insertDtc() {
	document.dtcForm.action="${pageContext.request.contextPath }/dtc/insertDtc.action";
	document.dtcForm.submit();
}

function deleteDtcList() {
	document.dtcForm.action="${pageContext.request.contextPath }/dtc/deleteDtcList.action";
	document.dtcForm.submit();
}
...
<div id="wrapper">
	...
	<form name="dtcForm" action="${pageContext.request.contextPath }/dtc/queryDtcByDcodePage.action" method="post">
	
	<div class="bs-example4" data-example-id="simple-responsive-table">
   <div class="mail-toolbar clearfix">
   <div class="input-group">
     <input type="text" name="custom.dcode" class="form-control1 input-search" placeholder="故障码编号">
    	...
    	<div class="float-left">
			<button type="button" class="btn btn-sm btn-default" onclick="insertDtc()">添加故障码</button>
			<button type="button" class="btn btn-sm btn-default" onclick="deleteDtcList()">批量删除</button>
		</div>
    ...
    <div class="table-responsive">
      <table class="table table-bordered">
        ...
        <tbody>
         <c:forEach items="${dtcList }" var="dtc" >
          <tr>
            <td><input type="checkbox" name="dtc_id" value="${dtc.did } "/></td>
            <td>${dtc.dcode }</td>
            <td>${dtc.dname }</td>
            <td>${dtc.dinfo }</td>
            <td>${dtc.dcause }</td>
            <td>${dtc.dfix }</td>
            <td><a href="${pageContext.request.contextPath }/dtc/editDtc.action?did=${dtc.did }">修改</a>
            <a href="${pageContext.request.contextPath }/dtc/deleteDtc.action?did=${dtc.did }">删除</a>
            </td>
          </tr>
          </c:forEach>
