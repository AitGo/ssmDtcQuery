...
function queryUserByUnamePage() {
	document.dtcForm.action="${pageContext.request.contextPath }/user/queryUserByUnamePage.action";
	document.dtcForm.submit();
}

function insertUser() {
	document.dtcForm.action="${pageContext.request.contextPath }/user/insertUser.action";
	document.dtcForm.submit();
}

function deleteUserList() {
	document.dtcForm.action="${pageContext.request.contextPath }/user/deleteUserList.action";
	document.dtcForm.submit();
}
...
<div id="wrapper">
	...
	<form name="dtcForm" action="${pageContext.request.contextPath }/user/queryUserByUnamePage.action" method="post">
   ...
   <div class="input-group">
     <input type="text" name="custom.uname" class="form-control1 input-search" placeholder="用户名">
          <span class="input-group-btn">
             <button class="btn btn-success" type="button" onclick="queryUserByUnamePage()"><i class="fa fa-search"></i></button>
             
          </span>
   </div><!-- Input Group -->
    	<div class="float-left">
			<button type="button" class="btn btn-sm btn-default" onclick="insertUser()">添加用户</button>
			<button type="button" class="btn btn-sm btn-default" onclick="deleteUserList()">批量删除</button>
		</div>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
         <c:forEach items="${userList }" var="user" >
          <tr>
            <td><input type="checkbox" name="user_id" value="${user.uid } "/></td>
            <td>${user.uid }</td>
            <td>${user.uname }</td>
            <td>${user.upassword }</td>
            <td><a href="${pageContext.request.contextPath }/user/editUser.action?uid=${user.uid }">修改</a>
