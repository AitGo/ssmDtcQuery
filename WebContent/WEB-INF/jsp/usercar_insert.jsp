				...
				<c:if test="${error!=null }">
					${ error}<br/>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="${pageContext.request.contextPath }/user/insertUserCarSubmit.action" method="post">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">用户名</label>
									<div class="col-sm-8">
										<input name="uname" type="text" class="form-control1" id="focusedinput" value="">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="upassword" type="text" class="form-control1" id="disabledinput" value="">
									</div>
								</div>
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">车辆名</label>
									<div class="col-sm-8">
										<input name="custom.cname" type="text" class="form-control1" id="disabledinput" value="">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">车辆品牌</label>
									<div class="col-sm-8">
										<input name="custom.ctype" type="text" class="form-control1" id="inputPassword" value="">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">出厂时间</label>
									<div class="col-sm-8">
										<input name="custom.cproduct" type="text" class="form-control1" id="inputPassword" value="">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">排量</label>
									<div class="col-sm-8">
										<input size="20" name="custom.cdisplacement" type="text" class="form-control1" id="inputPassword" value="">
									</div>
								</div>
